                    ...
                    <div class="card-body">
                        <form action="{{ route('states.store')}}" method="post">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" name="state_name" id="state_name" class="form-control @error('state_name') is-invalid @enderror" name="state_name" value="{{ old('state_name',$state->state_name) }}" required autocomplete="state_name" autofocus>
                                        @error('state_name')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
